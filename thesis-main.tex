...
Durante l'implementazione del VDC sono stati valutati altri applicativi per l'automazione del deployment e l'orchestrazione:
\begin{itemize}
...
Allo stesso tempo, Ansible, pur essendo un'ottima soluzione per la gestione di infrastrutture complesse, richiede una configurazione iniziale più complessa e non è uno strumento adatto per chi si approccia
