...
\end{itemize}
Un cluster composto da un nodo master e tre nodi worker sarà così composto:
\begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{figures/kube-vdc.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{figures/test-deployment.png}
...
Ora è possibile verificare il funzionamento in locale tramite \texttt{curl}.
\begin{lstlisting}
