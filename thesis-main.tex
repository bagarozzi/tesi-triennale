...
I pod vengono racchiusi in un servizio che espone il suo endpoint al cluster (Service di tipo ClusterIP); infine una risorsa Ingress espone il servizio all'esterno del cluster,
