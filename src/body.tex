...
\section{Cloud-Init}
Una tecnologia di \textit{Infrastructure-as-Code} con cui le istanze vengono configurate automaticamente al loro avvio installando pacchetti, scrivendo file di configurazione e inviando comandi alla shell. \\
\\
\textbf{Spiegare lati positivi e negativi dell'IAC.}
\\
